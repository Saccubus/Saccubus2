...
public:
	SimpleCommentFactory(cinamo::Logger& log, cairo::Renderer* renderer, const std::map<std::string, std::string> & config);
...
private:
	saccubus::draw::Sprite::Handler<saccubus::draw::Sprite> renderLine(std::shared_ptr<saccubus::draw::Context> ctx, std::string const& str, bool fitToScreen, unsigned long color, unsigned long shadowColor, double size);
	saccubus::draw::Sprite::Handler<saccubus::draw::Sprite> renderLines(std::shared_ptr<saccubus::draw::Context> ctx, std::string const& str, bool fitToScreen, unsigned long color, unsigned long shadowColor, double size);
public:
